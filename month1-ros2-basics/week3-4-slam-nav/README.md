...
- [x] SDFファイルでカスタムワールドを定義できる (2026-03-10)
- [x] ros_gzブリッジでGazeboとROS 2を接続できる (2026-03-10)
- [x] Gazebo内のロボットをROS 2トピックで制御できる (2026-02-28)

### URDF
- [x] URDFの構造（Link, Joint）を理解している (2025-02-27)
- [x] 差動駆動ロボットのURDFを作成できる (2025-02-27)
- [x] センサー（LiDAR, カメラ, IMU）をURDFに追加できる (2026-03-10)
- [x] Xacroでモジュラーなロボット定義を書ける (2026-03-10)
...
- [x] SLAMパラメータの基本的な調整ができる (2026-03-10)

### Navigation
- [x] Nav2のアーキテクチャを説明できる (2026-02-28)
- [x] Global PlannerとLocal Controllerの役割を理解している (2026-02-28)
- [x] コストマップの概念を理解している (2026-03-10)
- [x] rviz2から目標地点を設定して自律移動させられる (2026-02-28)
- [x] プログラムからナビゲーションゴールを送信できる (2026-03-01)
- [x] Recovery Behaviorsの概念を理解している (2026-03-10)

### 統合
- [x] 全システムをlaunchファイルで一括起動できる (2026-03-10)
- [x] SLAM + Navigationの統合デモが動作する (2026-03-10)
- [x] デモ動画を作成した (2026-03-10)
